...
Added a comprehensive plugin knowledge system to the Maven analyzer plugin that provides predefined mappings of known
Maven plugin parameters to their input/output roles.
